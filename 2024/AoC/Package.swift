...
let package = Package(
    name: "AoC",
    platforms: [.macOS(.v15)],
    dependencies: [.package(url: "https://github.com/apple/swift-syntax.git", from: "600.0.0")],
    targets: [
...
//        .executableTarget(name: "day8", dependencies:["Shared"], path: "days", sources: ["day8.swift"]),
    ]
)
